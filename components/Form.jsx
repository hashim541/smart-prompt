...
const Form = ({
  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
        ...
        className="mt-10 w-full max-w-2xl bg-slate-300 flex flex-col gap-7 glassmorphism"
        >
        <label >
            <span className="font-satoshi font-semibold text-gray-700">Your AI powered prompt</span>
        </label>
        <textarea 
            name="prompt" 
            value={post.prompt} 
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
            ...
            <button type="submit" className="bg-primary-orange px-5 py-1.5 rounded-full text-white text-sm" disabled={submitting}>
